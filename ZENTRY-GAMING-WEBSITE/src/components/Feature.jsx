  ...
  return (
    <section className="bg-black pb-52">
      <div className="container mx-auto px-3 md:px-10">
        ...
        <div className="grid h-[110vh] grid-cols-2 grid-rows-3 gap-7">
          ...
          <BentoTilt className="bento-tilt_1 row-span-1 md-14 md:col-span-1 md:me-0">
            <BentoCard
          ...
          <BentoTilt className="bento-tilt_2">
            <div className="flex size-full flex-col justify-between bg-violet-300 p-5">
              <h1 className="bento-title max-w-64 special-font text-black">
                M<b>o</b>re C<b>o</b>ming S<b>oo</b>n!
              </h1>
              <TiLocationArrow className="m-5 self-end scale-[8]
              text-black" />
            </div>
          </BentoTilt>
